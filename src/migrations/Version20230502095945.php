 ...
 */
final class Version20230502095945 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE video CHANGE media_type media_type ENUM(\'DEFAULT\', \'WEBINAR\', \'FIXED_SHOT\', \'HIGH_RESOLUTION\',\'GREEN++\',\'ANIMATION\',\'STILL_IMAGE\',\'TWITCH\'), CHANGE encoding_state encoding_state ENUM( \'PENDING\',\'ANALYSING\',\'RETRY\', \'ENCODING\', \'ENCODED\',\'ERROR\')');
    }
