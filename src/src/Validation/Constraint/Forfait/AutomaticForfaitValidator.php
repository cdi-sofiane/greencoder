...
class AutomaticForfaitValidator extends ConstraintValidator
{
    private $em;
    ...
    public function validate($value, Constraint $constraint)
    {
        ...
        switch ($this->context->getObject()->getNature()) {
            case Forfait::NATURE_HYBRID:
                if ($this->context->getObject()->getIsAutomatic() === null) {
            ...
            case Forfait::NATURE_STOCKAGE:
                ...
                if ($this->context->getObject()->getIsAutomatic() != false) {
                    $constraint->message = "must be false";
                    $this->context->buildViolation($constraint->message)
                        ->setParameter('{{string}}', $value)
                        ->addViolation();
                }
